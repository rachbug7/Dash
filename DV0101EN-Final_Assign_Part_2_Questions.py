...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            options={'label1':'Yearly Statistics','value1':'Yearly Statistics', 'label2':'Recession Period Statisstics','value':'Recession Period Statisitcs'},
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_sales = .groupby('Vehicle_Type')['Vehicles_Sold'].mean().reset_index()                           
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='',names='', title='Total Expenditure Share by Vehicle Type during Recessions'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(avr_data,x='Year',y='Vehicles_Sold',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(....,html.Div(....)],style={'display':'flex'}),
                html.Div(className='chart-item', children=[html.Div(....),html.Div(....)],style={'display':'flex'})
                ]
